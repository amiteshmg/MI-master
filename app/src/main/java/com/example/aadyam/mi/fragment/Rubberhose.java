...
public class Rubberhose extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_rubberhose, container, false);
    }
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
       ...
       // recyclerView = (RecyclerView)view.findViewById(R.id.rubberhose_recycler_view);
       // recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        rubberHoseLayout=view.findViewById(R.id.rubberhose_linear_layout);
